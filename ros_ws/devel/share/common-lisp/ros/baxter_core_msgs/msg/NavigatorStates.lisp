...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<NavigatorStates>)))
  ...
  "a9758278f6fd36425a5d4b2064a8f8ba")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'NavigatorStates)))
  "Returns md5sum for a message object of type 'NavigatorStates"
  "a9758278f6fd36425a5d4b2064a8f8ba")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<NavigatorStates>)))
  ...
  (cl:format cl:nil "# used when publishing multiple navigators~%string[]         names~%NavigatorState[] states~%~%================================================================================~%MSG: baxter_core_msgs/NavigatorState~%# OK button~%bool ok~%# Cancel button~%bool cancel~%# Show button~%bool show~%# Wheel button~%uint8   wheel~%~%# true if the inner light is on, false if not~%bool innerLight~%~%# true if the outer light is on, false if not~%bool outerLight~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'NavigatorStates)))
  "Returns full string definition for message of type 'NavigatorStates"
  (cl:format cl:nil "# used when publishing multiple navigators~%string[]         names~%NavigatorState[] states~%~%================================================================================~%MSG: baxter_core_msgs/NavigatorState~%# OK button~%bool ok~%# Cancel button~%bool cancel~%# Show button~%bool show~%# Wheel button~%uint8   wheel~%~%# true if the inner light is on, false if not~%bool innerLight~%~%# true if the outer light is on, false if not~%bool outerLight~%~%~%"))
